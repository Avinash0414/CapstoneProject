...
public class RestconfClientManager {
  ...
  public String postConfig(String urlStr, String requestBody) throws Exception {
        URL url = new URL(urlStr);
        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        conn.setRequestProperty("Accept", "application/yang-data+json");
        conn.setRequestProperty("Content-Type", "application/yang-data+xml");
        conn.setRequestProperty("Authorization", authHeader);
        conn.setDoOutput(true);

        System.out.println("POST Request URL: " + urlStr);
...
/* public String deleteConfig(String urlStr) throws Exception {
      URL url = new URL(urlStr);
      HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
      ...
      System.out.println("DELETE Request URL: " + urlStr);
